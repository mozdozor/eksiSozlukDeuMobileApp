...
public class AllArticlesActivity extends AppCompatActivity implements SelectListener {


    ArrayList<Article> articles = new ArrayList<>();
    ArrayList<String> comingComments = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        articlesRecycleViewAdapter adapterw = new articlesRecycleViewAdapter(this,articles,this);
                ...
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            if(articles.isEmpty()){
                                Toast.makeText(AllArticlesActivity.this,"No data found", Toast.LENGTH_LONG).show();
    ...
    public void onItemClicked(Article myArticle) {
        ...
        Intent i = new Intent(AllArticlesActivity.this, ShowDetailActivity.class);
